...
"""
 ...
 exten => s,1,Verbose(0, from-pstn-hdlr called)
  ...
  same => n,AGI(/usr/local/bin/freeswitch_logcall.sh,${odoo_type},${odoo_src},${odoo_dst},${odoo_duration},${odoo_start},${odoo_filename},${odoo_uniqueid})
  same => n,Return()

 To test from the CLI:
./freeswitch_logcall.sh << EOF
agi_arg_1: outgoing
agi_arg_2: 875
...
__author__ = "Trever L. Adams & Craig Gowing <craig.gowing@credativ.co.uk> & Alexis de Lattre <alexis.delattre@akretion.com>"
